...
export const categories: Category[] = [
  { id: 'vets', name: 'Veterinarias', slug: 'veterinarias', icon: '🐕' },
  { id: 'grooming', name: 'Estéticas Caninas', slug: 'esteticas', icon: '✂️' },
  { id: 'adoption', name: 'Adopción', slug: 'adopcion', icon: '❤️' },
  { id: 'daycare', name: 'Guarderías', slug: 'guarderias', icon: '🏠' },
  { id: 'training', name: 'Entrenamiento', slug: 'entrenamiento', icon: '🦴' },
  { id: 'shops', name: 'Tiendas de Accesorios', slug: 'tiendas', icon: '🛍️' },
];
